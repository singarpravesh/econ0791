...
## R-console
![R console](https://phonlab.sitehost.iu.edu/R/WebsiteImages/R%20upon%20open.PNG){width=700px}

## RStudio
![RStudio](https://bookdown.org/gary_a_napier/induction_-_introduction_to_r/_book/images/Image2_Retry.png){width=700px}
